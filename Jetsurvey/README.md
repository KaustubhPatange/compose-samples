...
[`MainActivity`][2] is the application's entry point. The screens and the navigation are defined & implemented in [`Navigation.kt`][4]. The navigation between them uses the [Navigation library][3].

[1]: app/src/main/java/com/example/compose/jetsurvey
[2]: app/src/main/java/com/example/compose/jetsurvey/MainActivity.kt
[3]: https://github.com/KaustubhPatange/navigator/tree/master/navigator-compose
